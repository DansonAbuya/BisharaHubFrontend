...
export default function AdminOwnersPage() {
  ...
  const handleAddOwner = async (e: React.FormEvent) => {
    ...
    try {
      await addOwner({ name, email, password })
      setSuccess('Owner added successfully. They can now log in.')
      setName('')
      setEmail('')
      setPassword('')
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new owner account. They will receive login credentials.
            </DialogDescription>
          </DialogHeader>
